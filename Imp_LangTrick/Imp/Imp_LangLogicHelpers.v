...
Tactic Notation "inv_Imp_Lang_app" hyp(H) "as" simple_intropattern(ARGS) simple_intropattern(FOLDARGS) simple_intropattern(BODY) simple_intropattern(RET) :=
  inv H as [ (* Imp_Lang_const *) | (* Imp_Lang_var *)
           | (* Imp_Lang_plus *)
           | (* Imp_Lang_minus *)
           | (* Imp_Lang_app *)
...
(* Occassionally when you use inversion on b_Imp_Lang, you also get an additional hypothesis
