...
From Imp_LangTrick Require Import Imp.Imp_LangTrickLanguage Imp.Imp_LangLogicHelpers StackLanguage StackLangTheorems.
...
match exp with
| CONST_Imp_Lang n => (empty_set string)
| VAR_Imp_Lang x => set_add string_dec x (empty_set string)
| PARAM_Imp_Lang n => (empty_set string)
| PLUS_Imp_Lang a1 a2 => 
...
match exp with
| TRUE_Imp_Lang => (empty_set string)
| FALSE_Imp_Lang => (empty_set string)
...
Definition construct_trans (imp: imp_Imp_Lang): (list ident) := 
  let free_vars := 
...
Definition stack_mapping (imp: imp_Imp_Lang): ident -> nat := 
...
Inductive aexp_has_variable : ident -> aexp_Imp_Lang -> Prop :=
| AexpHasVarVar :
  forall (id x: ident),
    String.eqb id x = true ->
    aexp_has_variable id (VAR_Imp_Lang x)
| AexpHasVarPlus__left :
  forall (id: ident) (a1 a2: aexp_Imp_Lang),
    aexp_has_variable id a1 ->
    aexp_has_variable id (PLUS_Imp_Lang a1 a2)
...
| AexpHasVarMinus__left :
  forall (id: ident) (a1 a2: aexp_Imp_Lang),
    aexp_has_variable id a1 ->
    aexp_has_variable id (MINUS_Imp_Lang a1 a2)
| AexpHasVarMinus__right :
  forall (id: ident) (a1 a2: aexp_Imp_Lang),
    aexp_has_variable id a2 ->
    aexp_has_variable id (MINUS_Imp_Lang a1 a2)
| AexpHasVarApp :
  forall (id: ident) (f: ident) (args: list aexp_Imp_Lang),
    args_has_variable id args ->
    aexp_has_variable id (APP_Imp_Lang f args)
with args_has_variable : ident -> list aexp_Imp_Lang -> Prop :=
| ArgsHasVarFirst :
  forall (id: ident) (arg: aexp_Imp_Lang) (args: list aexp_Imp_Lang),
...
Inductive bexp_has_variable: ident -> bexp_Imp_Lang -> Prop :=
| BexpHasVarNeg :
  forall (id: ident) (b: bexp_Imp_Lang),
    bexp_has_variable id b ->
    bexp_has_variable id (NEG_Imp_Lang b)
| BexpHasVarAnd__left :
  forall (id: ident) (b1 b2: bexp_Imp_Lang),
    bexp_has_variable id b1 ->
    bexp_has_variable id (AND_Imp_Lang b1 b2)
...
| BexpHasVarOr__left :
  forall (id: ident) (b1 b2: bexp_Imp_Lang),
    bexp_has_variable id b1 ->
    bexp_has_variable id (OR_Imp_Lang b1 b2)
| BexpHasVarOr__right :
  forall (id: ident) (b1 b2: bexp_Imp_Lang),
    bexp_has_variable id b2 ->
    bexp_has_variable id (OR_Imp_Lang b1 b2)                      
| BexpHasVarLeq__left :
  forall (id: ident) (a1 a2: aexp_Imp_Lang),
    aexp_has_variable id a1 ->
    bexp_has_variable id (LEQ_Imp_Lang a1 a2)
...
Inductive imp_has_variable : ident -> imp_Imp_Lang -> Prop :=
| ImpHasVarAssignee :
  forall (id: ident) (x: ident) (a: aexp_Imp_Lang),
    String.eqb id x = true ->
    imp_has_variable id (ASSIGN_Imp_Lang x a)
| ImpHasVarAssigned :
  forall (id: ident) (x: ident) (a: aexp_Imp_Lang),
    aexp_has_variable id a ->
    imp_has_variable id (ASSIGN_Imp_Lang x a)
| ImpHasVarSeq__left :
  forall (id: ident) (i1 i2: imp_Imp_Lang),
    imp_has_variable id i1 ->
    imp_has_variable id (SEQ_Imp_Lang i1 i2)
| ImpHasVarSeq__right :
  forall (id: ident) (i1 i2: imp_Imp_Lang),
    imp_has_variable id i2 ->
    imp_has_variable id (SEQ_Imp_Lang i1 i2)
| ImpHasVarIf__cond :
  forall (id: ident) (b: bexp_Imp_Lang) (i__then i__else : imp_Imp_Lang),
    bexp_has_variable id b ->
    imp_has_variable id (IF_Imp_Lang b i__then i__else)
| ImpHasVarIf__then :
  forall (id: ident) (b: bexp_Imp_Lang) (i__then i__else : imp_Imp_Lang),
...
| ImpHasVarWhile__cond :
  forall (id: ident) (b: bexp_Imp_Lang) (i__body : imp_Imp_Lang),
    bexp_has_variable id b ->
    imp_has_variable id (WHILE_Imp_Lang b i__body)
...
Lemma imp_has_variable_assign_iff :
  forall (assignee: ident) (a: aexp_Imp_Lang) (x: ident),
    imp_has_variable x (ASSIGN_Imp_Lang assignee a) <->
...
Lemma imp_has_variable_seq_iff :
  forall (i1 i2: imp_Imp_Lang) (x: ident),
    imp_has_variable x (SEQ_Imp_Lang i1 i2) <->
...
Lemma imp_has_variable_if_iff :
  forall (b: bexp_Imp_Lang) (i1 i2: imp_Imp_Lang) (x: ident),
    imp_has_variable x (IF_Imp_Lang b i1 i2) <->
...
Lemma imp_has_variable_while_iff :
  forall (b: bexp_Imp_Lang) (i__body : imp_Imp_Lang) (x: ident),
    imp_has_variable x (WHILE_Imp_Lang b i__body) <->
...
Inductive imp_existence_relation_on_aexps_bexps : (aexp_Imp_Lang -> Prop) -> (bexp_Imp_Lang -> Prop) -> imp_Imp_Lang -> Prop :=
| ImpExistenceVar :
  forall (p__a: aexp_Imp_Lang -> Prop) (p__b: bexp_Imp_Lang -> Prop) (x: ident) (a: aexp_Imp_Lang),
    p__a a ->
    imp_existence_relation_on_aexps_bexps p__a p__b (ASSIGN_Imp_Lang x a)
| ImpExistenceSeq__left :
  forall (p__a: aexp_Imp_Lang -> Prop) (p__b: bexp_Imp_Lang -> Prop) (i1 i2: imp_Imp_Lang),
    imp_existence_relation_on_aexps_bexps p__a p__b i1 ->
    imp_existence_relation_on_aexps_bexps p__a p__b (SEQ_Imp_Lang i1 i2)
| ImpExistenceSeq__right :
  forall (p__a: aexp_Imp_Lang -> Prop) (p__b: bexp_Imp_Lang -> Prop) (i1 i2: imp_Imp_Lang),
    imp_existence_relation_on_aexps_bexps p__a p__b i2 ->
    imp_existence_relation_on_aexps_bexps p__a p__b (SEQ_Imp_Lang i1 i2)
| ImpExistenceIf__cond :
  forall (p__a: aexp_Imp_Lang -> Prop) (p__b: bexp_Imp_Lang -> Prop) (b: bexp_Imp_Lang) (i__then i__else : imp_Imp_Lang),
    p__b b ->
    imp_existence_relation_on_aexps_bexps p__a p__b (IF_Imp_Lang b i__then i__else)
...
| ImpExistenceWhile__cond :
  forall (p__a: aexp_Imp_Lang -> Prop) (p__b: bexp_Imp_Lang -> Prop) (b: bexp_Imp_Lang) (i__body : imp_Imp_Lang),
    p__b b ->
    imp_existence_relation_on_aexps_bexps p__a p__b (WHILE_Imp_Lang b i__body)
| ImpExistenceWhile__body :
  forall (p__a: aexp_Imp_Lang -> Prop) (p__b: bexp_Imp_Lang -> Prop) (b: bexp_Imp_Lang) (i__body : imp_Imp_Lang),
    imp_existence_relation_on_aexps_bexps p__a p__b i__body ->
    imp_existence_relation_on_aexps_bexps p__a p__b (WHILE_Imp_Lang b i__body).

Inductive imp_forall_relation_on_aexps_bexps : (aexp_Imp_Lang -> Prop) -> (bexp_Imp_Lang -> Prop) -> imp_Imp_Lang -> Prop :=
| ImpForallSkip :
  forall (p__a: aexp_Imp_Lang -> Prop) (p__b: bexp_Imp_Lang -> Prop),
    imp_forall_relation_on_aexps_bexps p__a p__b SKIP_Imp_Lang
| ImpForallAssign :
  forall (p__a: aexp_Imp_Lang -> Prop) (p__b: bexp_Imp_Lang -> Prop) (x: ident) (a: aexp_Imp_Lang),
    p__a a ->
    imp_forall_relation_on_aexps_bexps p__a p__b (ASSIGN_Imp_Lang x a)
| ImpForallSeq :
  forall (p__a: aexp_Imp_Lang -> Prop) (p__b: bexp_Imp_Lang -> Prop) (i1 i2: imp_Imp_Lang),
    imp_forall_relation_on_aexps_bexps p__a p__b i1 ->
    imp_forall_relation_on_aexps_bexps p__a p__b i2 ->
    imp_forall_relation_on_aexps_bexps p__a p__b (SEQ_Imp_Lang i1 i2)
| ImpForallIf :
  forall (p__a: aexp_Imp_Lang -> Prop) (p__b: bexp_Imp_Lang -> Prop) (b: bexp_Imp_Lang) (i1 i2: imp_Imp_Lang),
    p__b b ->
    imp_forall_relation_on_aexps_bexps p__a p__b i1 ->
    imp_forall_relation_on_aexps_bexps p__a p__b i2 ->
    imp_forall_relation_on_aexps_bexps p__a p__b (IF_Imp_Lang b i1 i2)
| ImpForallWhile :
  forall (p__a: aexp_Imp_Lang -> Prop) (p__b: bexp_Imp_Lang -> Prop) (b: bexp_Imp_Lang) (i__loop : imp_Imp_Lang),
    p__b b ->
    imp_forall_relation_on_aexps_bexps p__a p__b i__loop ->
    imp_forall_relation_on_aexps_bexps p__a p__b (WHILE_Imp_Lang b i__loop).
...
Definition var_map_wf (var_map_list: list ident) : Prop :=
  ...
  /\ (forall (x: ident),
        ...
        exists (index: nat),
          one_index_opt x var_map_list = S index)
  /\ (forall (x: ident) (imp: imp_Imp_Lang),
        In x var_map_list ->
        var_map_list = construct_trans imp ->
        imp_has_variable x imp).

Definition var_map_wf_wrt_aexp (var_map_list: list ident) (aexp: aexp_Imp_Lang): Prop :=
  ...
  /\ (forall x (aexp_var_map: set ident),
        ...
        exists index,
          find_index_rel var_map_list x (Some index))
  /\ (forall x (f: ident) (args: list aexp_Imp_Lang) (aexp_var_map: set ident),
        aexp = APP_Imp_Lang f args ->
        aexp_var_map = free_vars_aexp_src aexp ->
        In x aexp_var_map ->
        args_has_variable x args).

Definition var_map_wf_wrt_bexp (var_map_list: list ident) (bexp: bexp_Imp_Lang): Prop :=
  var_map_wf var_map_list
...
Definition var_map_wf_wrt_imp (var_map_list: list ident) (imp: imp_Imp_Lang): Prop :=
  var_map_wf var_map_list
...
Require Import Imp_LangTrick.Imp.Imp_LangLogProp.

Section TryingOutThings.
  Local Open Scope imp_langtrick_scope.

  Definition my_program :=
    "x" <- ((CONST_Imp_Lang 3) +d (CONST_Imp_Lang 2)) ;;
    "y" <- ((VAR_Imp_Lang "x") +d (CONST_Imp_Lang 3)) ;;
    "z" <- ((VAR_Imp_Lang "x") +d (CONST_Imp_Lang 3)).

  
  Fixpoint remove_var (var: ident) (i: imp_Imp_Lang): imp_Imp_Lang :=
    match i with
    | ASSIGN_Imp_Lang x a => if String.eqb x var then SKIP_Imp_Lang else ASSIGN_Imp_Lang x (imp_lang_aexp_update var (CONST_Imp_Lang 1) a)
    | IF_Imp_Lang b i1 i2 =>
        IF_Imp_Lang (imp_lang_bexp_update var (CONST_Imp_Lang 1) b) (remove_var var i1) (remove_var var i2)     
    | WHILE_Imp_Lang b i =>
        WHILE_Imp_Lang (imp_lang_bexp_update var (CONST_Imp_Lang 1) b) (remove_var var i)
    | SEQ_Imp_Lang i1 i2 =>
        SEQ_Imp_Lang (remove_var var i1) (remove_var var i2)
    | SKIP_Imp_Lang => SKIP_Imp_Lang
    end.
  ...
  Definition another_program' :=
    "x" <- ((VAR_Imp_Lang "y") +d (VAR_Imp_Lang "z")) ;;
    "z" <- ((VAR_Imp_Lang "z") -d (VAR_Imp_Lang "y")).

  Definition another_program'' :=
    "x" <- ((VAR_Imp_Lang "y") +d (VAR_Imp_Lang "z")) ;;
    "z" <- ((VAR_Imp_Lang "y") -d (VAR_Imp_Lang "z")).
