...
From Imp_LangTrick.Stack Require Import StackLanguage StackLangTheorems.
...
Ltac smart_unfold :=
  ...
  | [ |- _ ] =>
      idtac "neither aexp_stack_pure nor bexp_stack_pure"
  end.
...
Proof.
  ...
  - invc H1. eapply H in H8. eapply H0 in H9. subst. auto.
  - invc H1. eapply H in H8. eapply H0 in H9. subst. auto.
  - invc H1. eapply H in H8. eapply H0 in H9. subst. auto.
...
Proof.
  ...
  - invs H.
    ...
    + simpl. constructor.
      * assumption.
      * rewrite app_length. rewrite <- Nat.add_succ_l. lia. 
